...
cutoffs_full <- readRDS("../Molecular/eDNA_camtrap/clean_data/COI_len100_cutoffs90_100.RDS")
str(cutoffs_full[[1]])
...
# DLP 7_8 (July 3-10) (only 8AB sequenced; + S/XS)
# HOY 2_3 (June 22-29) (+ 3AB S/XS)
# KWA 5_6 (June 19-26) (+ 6A S/XS and 6B S (XS to be sequenced))
# NGO 2_3 (June 24-July 1) (+ 3AB S (3AB XS to be sequenced))
# NWA 1_2 (June 19-26) (only NWA 2AB sequenced; + NWA 2AB S (2AB XS to be sequenced))
# NYA 2_3_4 (June 24-July 1; July 1-8) (+ NYA 4AB S (4AB XS to be sequenced))
...
# save.image("merged_eDNA_camtrap_data_dec14.RData")
